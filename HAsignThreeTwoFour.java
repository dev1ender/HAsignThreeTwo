...
public class HAsignThreeTwoFour {
	...
	// function created that will recursivly call itself if their exist a
	// subdir. into the dir
	// then it will call itself otherwise it will print the filees contained
	// itself
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		// calling traveringDir method first time so passed the path which is to
		// be recursilly traversed
